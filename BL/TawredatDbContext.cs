...
namespace BL
{
    public partial class TawredatDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        public virtual DbSet<TbEvaluationProduct> TbEvaluationProducts { get; set; }
        ...
        public virtual DbSet<TbSubscriptionRequest> TbSubscriptionRequest { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TbSubscriptionRequest>(entity =>
            {
            ...
            modelBuilder.Entity<TbEvaluationProduct>(entity =>
            {
                entity.HasKey(e => e.ProductEvaluationId);

                entity.ToTable("TbEvaluationProduct");

                entity.Property(e => e.ProductEvaluationId).HasDefaultValueSql("(newid())");
                ...
                entity.Property(e => e.ProductEvaluationText).HasMaxLength(200);
            ...
            modelBuilder.Entity<TbStore>(entity =>
            {
                ...
                entity.Property(e => e.StoreDescription).HasMaxLength(200);

                entity.Property(e => e.StoreImage).HasMaxLength(200);
