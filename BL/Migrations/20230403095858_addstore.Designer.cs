...
namespace BL.Migrations
{
    ...
    [Migration("20230403095858_addstore")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TbProductTbStore", b =>
                {
                    b.Property<Guid>("TbProductsProductId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("TbStoresStoreId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("TbProductsProductId", "TbStoresStoreId");

                    b.HasIndex("TbStoresStoreId");

                    b.ToTable("TbProductTbStore");
                });
            ...
            modelBuilder.Entity("TbProductTbStore", b =>
                {
                    b.HasOne("Domains.TbProduct", null)
                        .WithMany()
                        .HasForeignKey("TbProductsProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domains.TbStore", null)
                        .WithMany()
                        .HasForeignKey("TbStoresStoreId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
