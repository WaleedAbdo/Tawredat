...
namespace TawredatProject.Controllers
{
    public class AccountRepository : IAccountRepository
    {
        ...
        public async Task<ApplicationUser> FindByPhoneNumbaer(string PhoneNumber)
        {
            var data = await Usermanager.Users.FirstOrDefaultAsync(a => a.PhoneNumber == PhoneNumber);
            
            return data;
        }

        public async Task<ApplicationUser> FindByOTPNumber(string OTP, string PhoneNumber)
        {
            var data = await Usermanager.Users.FirstOrDefaultAsync(a => a.OTP == OTP&& a.PhoneNumber==PhoneNumber);
            return data;
        }
    }
}
